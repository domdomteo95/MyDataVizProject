...
bar = bar + scale_fill_manual("Continents", values = c("Africa" = "#a6cee3", "Asia" = "#1f78b4", "Europe" = "#b2df8a", "N.America" = "#33a02c", "Oceania" = "#fb9a99"))
...
bar + theme(legend.text = element_text(size = 5), legend.title = element_text(size = 6))
...
bar1 = bar1 + scale_fill_manual("Continent", values = c("Africa" = "#a6cee3", "Asia" = "#1f78b4", "Europe" = "#b2df8a", "S.America" = "#e31a1c"))
...
bar1 + theme(legend.text = element_text(size = 5), legend.title = element_text(size = 6))
```
...
bar2 = bar2 + scale_fill_manual("Continents", values = c("Africa" = "#a6cee3", "Asia" = "#1f78b4", "Europe" = "#b2df8a", "N.America" = "#33a02c", "Oceania" = "#fb9a99", "S.America" = "#e31a1c"))
...
bar2 + theme(legend.text = element_text(size = 5), legend.title = element_text(size = 6))
...
par_average + geom_text(x =1, y =22, label = "Average among 193 countries", size =3) + theme(legend.position = "none")
...
scatter1 = scatter1 + scale_color_manual("Continent", values = c("palevioletred3", "lightsalmon3", "thistle3","lightgoldenrod3", "darkseagreen3", "royalblue3"))  
